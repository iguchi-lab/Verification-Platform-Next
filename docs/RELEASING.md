...
```text
<case_name>_v1.3.1_input.json
<case_name>_v1.3.1_output1.csv
<case_name>_v1.3.1_output2.csv
<case_name>_v1.3.1_manifest.json
```
...
git switch main
git pull --ff-only
git tag -a v1.3.1 -m "Verification Platform Next ver.1.3.1"
git push origin v1.3.1
gh release create v1.3.1 --title "Verification Platform Next ver.1.3.1"
```
