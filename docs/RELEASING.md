...
```text
<case_name>_v1.4.0_input.json
<case_name>_v1.4.0_output1.csv
<case_name>_v1.4.0_output2.csv
<case_name>_v1.4.0_manifest.json
```
...
git switch main
git pull --ff-only
git tag -a v1.4.0 -m "Verification Platform Next ver.1.4.0"
git push origin v1.4.0
gh release create v1.4.0 --title "Verification Platform Next ver.1.4.0"
```
