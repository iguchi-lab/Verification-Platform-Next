...
# JJJ_EXPERIMENT ADD
from pyhees.jjj_markers import jjj_cloning, jjj_mod
...
def get_b_eq3(q_rtd_C):
    ...
    """
    q_rtd_C = min(_jjj_constant("q_rtd_C_limit"), q_rtd_C)
...
def get_C_df_H(Theta_ex, h_ex):
    ...
    C_df_H[(Theta_ex < _jjj_constant("defrost_temp_rac")) * (h_ex >= _jjj_constant("defrost_humid_rac"))] = _jjj_constant("C_df_H_d_t_defrost_rac")
    return C_df_H
