...
ronbun_spec_hi_C = C_CatalogSpec(
    name = "論文-高機能機-冷房",
    q_rac_min = 0.7,
    q_rac_rtd = 2.2,
    q_rac_max = 3.3,
    ...
    V_rac_inner = 12.1,
    V_rac_outer = 28.2,
    Theta_rac_inner = t_inner_C,
    Theta_rac_outer = t_outer_C,
    X_rac_inner = absolute_humid(rh_inner_C, t_inner_C),
    X_rac_outer = absolute_humid(rh_outer_C, t_outer_C)
    )

ronbun_spec_cmm_C = C_CatalogSpec(
    name = "論文-普及機-冷房",
    q_rac_min = 0.9,
    q_rac_rtd = 2.2,
    q_rac_max = 2.8,
...
ronbun_spec_hi_H = H_CatalogSpec(
    name = "論文-高機能機-暖房",
    q_rac_min = 0.7,
    q_rac_rtd = 2.5,
    q_rac_max = 5.4,
    ...
    V_rac_inner = 13.1,
    V_rac_outer = 25.5,
    Theta_rac_inner = t_inner_H,
    Theta_rac_outer = t_outer_H,
    X_rac_inner = absolute_humid(rh_inner_H, t_inner_H),
    X_rac_outer = absolute_humid(rh_outer_H, t_outer_H)
    )

ronbun_spec_cmm_H = H_CatalogSpec(
    name = "論文-普及機-暖房",
    q_rac_min = 0.9,
    q_rac_rtd = 2.2,
    q_rac_max = 3.6,
...
class Test成績係数比R_モデリング:
    ...
    def test_論文計算再現_高機能機_冷房(self):
        """ 論文のR近似式が再現できることを確認
        """
        a2, a1, a0, Pc = calc_R_and_Pc_C(ronbun_spec_hi_C)
    ...
    def test_論文計算再現_普及機_冷房(self):
        """ 論文のR近似式が再現できることを確認
        """
        a2, a1, a0, Pc = calc_R_and_Pc_C(ronbun_spec_cmm_C)
    ...
    def test_論文計算再現_高機能機_暖房(self):
        """ 論文のR近似式が再現できることを確認
        """
        a2, a1, a0, Pc = calc_R_and_Pc_H(ronbun_spec_hi_H)
    ...
    def test_論文計算再現_普及機_暖房(self):
        """ 論文のR近似式が再現できることを確認
        """
        a2, a1, a0, Pc = calc_R_and_Pc_H(ronbun_spec_cmm_H)
