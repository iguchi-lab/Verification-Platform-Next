...
from jjjexperiment.underfloor_ac.section4_2_jjj import get_r_A_NR_uf_1F
...
class Test式52負荷バランス時非居室室温:
    ...
    def test_暖房期_基本計算1(self):
        ...
        # Assert
        assert result == pytest.approx(18.7957, abs=1e-4)
    ...
    def test_暖房期_基本計算2(self):
        ...
        # Assert
        assert result == pytest.approx(18.0703, abs=1e-4)
    ...
    def test_冷房期_基本計算1(self):
        ...
        # Assert
        assert result == pytest.approx(27.0454, abs=1e-4)
